...
function ProfilePanel() {
    ...
    const profile_image = profile?.user?.profile_image || profile?.profileImage || null;
    ...
    return (
        <Box sx={{ flexGrow: 1, overflowY: "auto" }}>
            ...
            >
                ...
                <Typography variant="h6" fontWeight="bold" align="center" sx={{ mt: 2, fontSize: 14 }}>
                    {first_name} {last_name}
                </Typography>
                <Typography variant="body2" color="text.secondary" align="center" sx={{ mt: 0.2, fontSize: 12 }}>
                    {gmail}
                </Typography>
            </Box>
